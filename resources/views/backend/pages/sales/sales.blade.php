                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="company">Store <small>(Optional)</small></label>
                                <div class="input-group">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select name="user_id" id="user_id" class="form-control">
                                        ...
                                        @foreach ($sales_agents as $sales_agent)
                                            <option value="{{ $sales_agent->id }}">{{ $sales_agent->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            @endif
                            ...
                            @if (Auth::user()->branch_id != 3)
                                <div class="form-group col-6">
                                    <label>Agreed Delivery Date</label>
                                    <input type="date" class="form-control" id="agreed_delivery_date" name="agreed_delivery_date">
                                </div>
