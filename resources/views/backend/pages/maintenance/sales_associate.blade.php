                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="sales_associate" name="sales_associate" placeholder="Enter Sales Associate">
                            </div>
                            <div class="form-group col-12">
                                <label>Status</label>
...
<script src="/js/page/sales_associate.js"></script>
@endsection
