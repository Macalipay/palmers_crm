    ...
    <div class="row">
        ...
        <div class="col-2">
            <div class="filter mb-1">
                <select name="growth_year" id="growth_year" class="form-control form-control-sm" onchange="filterByDate()">
                    @for ($i = date('Y', strtotime('- 1year')); $i >= 2000; $i--)
                        <option value="{{$i}}">{{$i}}</option>
                    @endfor
                </select>
                <span style="font-style:italic;font-size:10px;">For sales growth comparison</span>
            </div>
        </div>
        <div class="col-2">
            <div class="filter mb-1">
                ...
                <span style="font-style:italic;font-size:10px;">Generate report</span>
            </div>
        </div>
    </div>
            ...
            <div class="grid-card-1 g-c" onclick="getDaily()">
                <div class="gcard">
                    <div id="transaction">
                        ...
                        <h1>0</h1>
                        <div class="translate">
                            <span>Total Transaction Annually</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="grid-card-2 g-c green" onclick="getDaily()">
                <div class="gcard">
                    <div id="daily">
                        ...
                        <h1>0</h1>
                        <div class="translate">
                            <span>Total sales Annually</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/js/page/annual.js"></script>
@endsection
