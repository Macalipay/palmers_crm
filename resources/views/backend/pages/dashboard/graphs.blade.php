...
<main class="content">
    <div class="row mb-2">
        ...
        <div class="col-3">
            <div class="filter text-right">
                <input type="date" class="form-control form-control-sm" id="filter_date" onchange="filterByDate()">
            </div>
        </div>
    </div>
    ...
    <div class="viewed-analytics">
        <div class="grid-container show" id="general_report">
            <div class="grid-card-1 g-c" onclick="getDaily()">
                <div class="gcard">
                    <div id="transaction">
                        ...
                        <h1>0</h1>
                        <div class="translate">
                            <span>Total transaction today</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- <div class="grid-bar g-c">
                <div>
                    <div id="source_record">
                        <div class="title">
                            <h5 class="card-title">
                                <i class="fas fa-chart-bar"></i> Sales by Source
                            </h5>
                        </div>
