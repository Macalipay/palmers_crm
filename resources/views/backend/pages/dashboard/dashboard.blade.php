...
<main class="content">
    <div class="container-fluid">
        ...
        <div class="header">
            ...
            <p class="header-subtitle">Summary of Poll/Survey.</p>
        </div>
            ...
            <div class="col-md-6 col-lg-3 col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- <h1 class="display-5 mt-1 mb-3">{{$voters_city}}</h1> --}}
                        <div class="mb-0">
            ...
            <div class="col-md-6 col-lg-3 col-xl">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col mt-0">
                                <h5 class="card-title">Done Poll/Survey</h5>
                            </div>
                        ...
                        {{-- <h1 class="display-5 mt-1 mb-3">{{$done}}</h1> --}}
                        <div class="mb-0">
                            <span class="text-default"> Total Done Poll/Survey.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xl">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col mt-0">
                                <h5 class="card-title">Active Poll/Survey</h5>
                            </div>
                        ...
                        <h1 class="display-5 mt-1 mb-3"></h1>
                        <div class="mb-0">
                            <span class="text-default"> Total Active Poll/Survey.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xl">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col mt-0">
                                <h5 class="card-title">Hold Poll/Survey</h5>
                            </div>
                        ...
                        <h1 class="display-5 mt-1 mb-3"></h1>
                        <div class="mb-0">
                            <span class="text-default"> Total Hold Poll/Survey.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 col-xl">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col mt-0">
                                <h5 class="card-title">Cancelled Poll/Survey</h5>
                            </div>
                        ...
                        <h1 class="display-5 mt-1 mb-3">{{$cancelled}}</h1>
                        <div class="mb-0">
                            <span class="text-default"> Total Cancelled Poll/Survey.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="row col-12">
                    <div class="col-3">
                        ...
                        <div class="poll-action"><a href="{{url('poll/survey-analyst/' . $poll_create->id)}}" class="btn btn-primary">Poll/Survey Analyst</a></div>
                    </div>
                    ...
                    <div class="col-9">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col mt-0">
                                        <h5 class="card-title">{{ $poll_create->title}} - Votes Summary</h5>
                                    </div>
                                </div>
                                <br>
                                    <table id="datatables" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                                @forelse ($poll_datas as $poll_data)
                                                    ...
                                                    @php ($vote =  App\PollVote::where('poll_id', $poll_data->poll_id)->where('politician_id', $poll_data->politician_id)->count())
                                                    @php ($total_vote =   App\PollVote::where('poll_id', $poll_data->poll_id)->where('position_id', $poll_data->position_id)->groupBy('position_id', 'poll_id')->count())
                                                    {{-- @php ($percentage = $vote / $total_vote) --}}
                                                        <tr>
                                                            ...
                                                            <td class="text-right">{{ $count = App\PollVote::where('poll_id', $poll_data->poll_id)->where('politician_id', $poll_data->politician_id)->count() }}</td>
                                                            <td class="d-none d-xl-table-cell">
                                                                <div class="progress">
                                                                    @if (App\PollVote::where('poll_id', $poll_data->poll_id)->where('position_id', $poll_data->position_id)->groupBy('position_id', 'poll_id')->count() !== 0)
                                                                    <div class="progress-bar bg-primary-dark" role="progressbar" style="width: {{($count / App\PollVote::where('poll_id', $poll_data->poll_id)->where('position_id', $poll_data->position_id)->groupBy('position_id', 'poll_id')->count()) * 100}}%" solve="{{$count}}">{{
                                                                        number_format(($count/App\PollVote::where('poll_id', $poll_data->poll_id)->where('position_id', $poll_data->position_id)->groupBy('position_id', 'poll_id')->count()) * 100, 2)
                                                                    }}%</div>
                                                                    @endif
                                                                </div>
                                                            </td>
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            //             tag.push(data.piechart[i].tagtype.tag);
            //             total.push(data.piechart[i].total);
            //             color.push(data.piechart[i].tagtype.color);
            //         }
            //         // Pie chart
