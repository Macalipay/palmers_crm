...
<main class="content">
    <div class="row mb-2">
        ...
        <div class="col-md-3 col-sm-12">
            <input type="date" class="form-control form-control-sm" id="end_date" name="end_date" value="{{date('Y-m-t')}}">
        </div>
            ...
            <div class="grid-card-1 g-c">
                <div class="gcard">
                    <div id="transaction">
                        ...
                        <h1><span id="total_calls">{{$calls}}</span></h1>
                        <div class="translate">
                            <span>Overall total of calls</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="grid-card-2 g-c">
                <div class="gcard">
                    <div id="daily">
                        ...
                        <h1><span id="merchandiser_value">{{$incomplete}}</span></h1>
                        <div class="translate">
                            <span>Total of incomplete calls</span>
                        </div>
            ...
            <div class="grid-card-3 g-c">
                <div class="gcard">
                    <div id="daily">
                        ...
                        <h1><span id="associate_value">{{$complete}}</span></h1>
                        <div class="translate">
                            <span>Total of complete calls</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            ...
            <div class="grid-card-4 g-c">
                <div class="gcard">
                    <div id="daily">
                        ...
                        <h1><span id="source_value">{{$cancel}}</span></h1>
                        <div class="translate">
                            <span>Total of cancelled calls</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            </div>
            <div class="grid-card-5 g-c g-success">
                <div class="gcard">
                    <div id="daily">
                        <div class="title">
                            <h5 class="card-title">
                        ...
                        <h1><span id="source_value">{{$transaction}}</span></h1>
                        <div class="translate">
                            <span>Overall total transactions</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            ...
            <div class="grid-card-6 g-c">
                <div class="gcard">
                    <div id="daily">
                        ...
                        <h1>₱ <span id="source_value">{{number_format($sale, 2)}}</span></h1>
                        <div class="translate">
                        ...
                        <div class="company-list">
                            @foreach ($company as $item)
                                <div class="company-item">
                                    <div class="row">
                                        <div class="c-name col-8">{{$item['company']['company_name']}}</div>
                                        <div class="c-amount col-4 text-right">₱ {{number_format($item['sales_amount'], 2)}}</div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        <div class="translate">
                            <span>List of companies involved</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            </div>
            <div class="grid-card-8 g-c">
                <div class="gcard" onclick="clickCard('source')" id="source">
                    <div style="height: 100%">
                        ...
                        <div class="agents-list">
                            @foreach ($agent as $item)
                                <div class="agents-item">
                                    <div class="row">
                                        <div class="c-name col-8">{{$item['user'] !== null?$item['user']['name']:'-'}}</div>
                                        <div class="c-amount col-4 text-right">₱ {{number_format($item['sales_amount'], 2)}}</div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="translate">
                            <span>List of agents involved</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            </div>
            <div class="grid-card-9 g-c">
                <div class="gcard" onclick="clickCard('source')" id="source">
                    <div style="height: 100%">
                        <div class="title">
                            <h5 class="card-title">
                        ...
                        <div class="divisions-list">
                            @foreach ($division as $item)
                                <div class="divisions-item">
                                    <div class="row">
                                        <div class="c-name col-8">{{$item['division']['division']}}</div>
                                        <div class="c-amount col-4 text-right">₱ {{number_format($item['sales_amount'], 2)}}</div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="translate">
                            <span>List of divisions involved</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
            </div>
            <div class="grid-card-10 g-c">
                <div class="gcard">
                    <div style="height: 100%">
                        <div class="title">
                            <h5 class="card-title">
                        ...
                        <div class="sales_associate-list">
                            @foreach ($sales_associate as $item)
                                <div class="sales_associate-item">
                                    <div class="row">
                                        <div class="c-name col-8">{{$item['sales_associate'] !== null?$item['sales_associate']['sales_associate']:"-"}}</div>
                                        <div class="c-amount col-4 text-right">₱ {{number_format($item['sales_amount'], 2)}}</div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="translate">
                            <span>List of sales associates involved</span>
                        </div>
                        <div class="filter-display"></div>
                    </div>
                </div>
